...
export function draw_myself(_canvas, context, tile_size_in_canvas, animation_order){
    ...
    const BAT_ADJUSTMENT = 6;             // NOTE: こうもりがタイルの少し上側に寄って描画されてしまうので、下方向に位置を調整。
    const MARGIN_LEFT = 6;
    const MARGIN_RIGHT = 6;
    const MARGIN_TOP = 12 - BAT_ADJUSTMENT;
